...
export const IP = {
  ...
  base: {
    ...
    fakeValue: DC.D5,
    multValue: () => {
      const div = Effects.min(450, Achievement(103), TimeStudy(111));
  ...
  divisor: {
    ...
    displayOverride: () => {
      const div = Effects.min(450, Achievement(103), TimeStudy(111));
      return `log(AM)/${formatInt(450)} ➜ log(AM)/${format(div, 2, 1)}`;
    },
    powValue: () => 450 / Effects.min(450, Achievement(103), TimeStudy(111)),
